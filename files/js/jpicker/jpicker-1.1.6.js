...
(function($, version)
{
  ...
  $.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      images:
        {
          clientPath: '/files/js/jpicker/images/', /* Path to image files */
          colorMap:
          {
            width: 256,
            height: 256,
      ...
      localization: /* alter these to change the text presented by the picker (e.g. different language) */
        {
          text:
          {
            title: 'Перетащите маркер для выбора цвета',
            newColor: 'новый',
          ...
          tooltips:
          {
            colors:
            {
              newColor: 'Новый цвет - Нажмите &ldquo;Выбрать&rdquo; для применения изменений',
              currentColor: 'Нажмите Отмена для возврату к старому цвету'
            },
            buttons:
            {
              ok: 'Подтверждение выбора цвета',
              cancel: 'Отмена выбора и возврат к старому цвету'
            },
            hue:
            {
