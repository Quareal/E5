 ...
 *
 * The class provides two methods, encode() and decode(), which do exactly
...
class idna_convert
{
    ...
    var /*static*/ $_mb_string_overload =  null;
    ...
    var $_idn_version = 2003;      // Can be either 2003 (old, default) or 2008
     ...
     * @since 0.5.2
     */
    /*public*/ function /*__construct*/idna_convert($options = false)
    {
     ...
     * @return int
     */
    /*var */function _adapt($delta, $npoints, $is_first)
    {
     ...
     */
    /*var */function _hangul_decompose($char)
    {
     ...
     */
    /*var */function _hangul_compose($input)
    {
        $inp_len = count($input);
     ...
     */
    /*var */function _get_combining_class($char)
    {
     ...
     */
    /*var */function _apply_cannonical_ordering($input)
    {
        $swap = true;
        $size = count($input);
        while ($swap) {
     ...
     * @return string
     */
    /*var */function _utf8_to_ucs4($input)
    {
        $output = array();
        $out_len = 0;
     ...
     * @return string
     */
    /*var */function _ucs4_to_utf8($input)
    {
        $output = '';
     ...
     * @return string
     */
    /*var */function _ucs4_to_ucs4_string($input)
    {
        $output = '';
     ...
     * @return array
     */
    /*var */function _ucs4_string_to_ucs4($input)
    {
        $output = array();
        $inp_len = $this->byteLength($input);
     ...
     */
    /*var static */function byteLength($string)
    {
        //if ($this->$_mb_string_overload) {
            //return mb_strlen($string, '8bit');
       //}
        //$x=imap_binary($string);/*(binary)$string*/;  // <<- ???
        $x=/*(binary)*/$string;
        return strlen($x);
    }
